...
namespace Baskom.Controller
{
    class c_Dashboard
    {
        ...
        {
            v_DaftarMitra v_DaftarMitra = new(this, this.m_DataMitra);
            v_DaftarMitra.init();
            v_DaftarMitra.Show();
        }
        ...
        {
            v_MemvalidasiKonversiNilai v_MemvalidasiKonversiNilai = new(this, this.m_DataKonversiSks, this.m_DataKonversiNilai, this.m_DataAkunDosen, this.m_DataAkunMahasiswa, this.m_DataProdi, this.m_DataPenerimaanMitra, this.m_DataMitra, this.m_DataProgram, this.m_DataPembagianTugas, (m_DataAkunTimmbkm)this.data_akun_pengguna);
        ...
        public void setTambahDosenTimmbkm(v_DataDosen v_DataDosen)
        {
            v_TambahDosenTimmbkm v_TambahDosenTimmbkm = new(this.m_DataAkunTimmbkm, this.m_DataAkunDosen, v_DataDosen);
