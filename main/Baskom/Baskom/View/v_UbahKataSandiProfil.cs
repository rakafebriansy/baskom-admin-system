...
namespace Baskom.View
{
    partial class v_UbahKataSandiProfil : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (kata_sandi_baru.Length >= 8 & konfirmasi.Length >= 8)
                {
                ...
                {
                    MessageBox.Show("Minimal 8 Karakter!");
                }
            }
        ...
        private void tbx_katasandibaru_TextChanged(object sender, EventArgs e)
        {
            tbx_katasandibaru.ForeColor = Color.Black;
            tbx_katasandibaru.PasswordChar = '*';
        }

        private void tbx_konfirmasikatasandibaru_TextChanged(object sender, EventArgs e)
        {
            tbx_konfirmasikatasandibaru.ForeColor = Color.Black;
            tbx_konfirmasikatasandibaru.PasswordChar = '*';
        }
    }
}
